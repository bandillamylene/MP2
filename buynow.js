...
function proceedButton() {
    ...
    // Get the element where you want to display the order number
...
function handleFormSubmission() {
    proceedButton(); // Call the proceedButton function

    // Call the populateReviewForm function after a slight delay
    setTimeout(function() {
        populateReviewForm();
    }, 100);
