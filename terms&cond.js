// Function to set the content of the Terms and Conditions modal
const setTermsAndConditions = () => {
    // HTML content for the Terms and Conditions modal
    const termsContent = `
    ...
    // Set the HTML content to the specified modal body element
    document.getElementById('termsModalBody').innerHTML = termsContent;
};

// Event listener for the Terms and Conditions link click
document.getElementById('termsLink').addEventListener('click', () => {
    // Call the setTermsAndConditions function to populate the modal content
